...
- [x] deterministic SDL2 controller reconciliation regression
...
- [x] explicit maintainer approval for the unsigned, ROM-free `v0.1.2`
      GitHub Release
- [ ] written legal review before paid access, commercial binary licensing,
      or official-store distribution

The `v0.1.2` authorization is limited to the unsigned GitHub Release. Signing,
